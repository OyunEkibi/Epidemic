...
if [ -f "E:\Programs\EpicGames\Epic Games\4.9\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "E:\Programs\EpicGames\Epic Games\4.9\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
